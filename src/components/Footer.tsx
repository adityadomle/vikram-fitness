  ...
  return (
    <footer className="bg-foreground text-primary-foreground/70 py-12 px-6 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <span className="font-heading text-xl text-primary-foreground">ELY COHEN</span>
        ...
        <span className="text-xs">&copy; {new Date().getFullYear()} Ely Cohen. All rights reserved.</span>
      </div>
    </footer>
  );
};
